...
side_hustles =[
    ...
    "Print-on-Demand - Sell custom desighnes products!",
    "Blogging - Create content and earn through ads and sponsorships!",
    "Youtube Channel - Monetize videos through ads and sponsorship!",
...
def read_root():
    return {
        "message": "Hello World, Go to /side_hustles?apiKey=123456789 or /money_quotes?apiKey=123456789 to get a random side hustle or money quote"
    }
